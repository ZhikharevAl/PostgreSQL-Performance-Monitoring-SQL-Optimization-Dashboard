...
- [🌟 Как сделать дашборд еще круче?](#-как-сделать-дашборд-еще-круче)
...
### 📈 Топ-10 запросов по количеству вызовов
...
### ⏱️ Топ-10 запросов по общему времени выполнения
...
### 🐌 Топ-10 самых медленных запросов (среднее время)
